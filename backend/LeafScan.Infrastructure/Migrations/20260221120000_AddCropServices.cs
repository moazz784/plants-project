    ...
    public partial class AddCropServices : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table => table.PrimaryKey("PK_Climates", x => x.Id));
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => table.PrimaryKey("PK_SoilTypes", x => x.Id));
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    CropId = table.Column<int>(type: "int", nullable: false),
                    WaterLitersPerAcrePerWeek = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    FertilizerKgPerAcre = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
        ...
        {
            migrationBuilder.DropTable(name: "CropRequirements");
            migrationBuilder.DropTable(name: "CropSoilClimates");
            migrationBuilder.DropTable(name: "Crops");
            migrationBuilder.DropTable(name: "Climates");
            migrationBuilder.DropTable(name: "SoilTypes");
        }
    }
}
