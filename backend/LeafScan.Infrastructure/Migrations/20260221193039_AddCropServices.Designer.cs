...
namespace LeafScan.Infrastructure.Migrations
{
    ...
    [Migration("20260221193039_AddCropServices")]
    partial class AddCropServices
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LeafScan.Domain.Entities.CropRequirement", b =>
                {
                    b.HasOne("LeafScan.Domain.Entities.Crop", "Crop")
                        ...
                        .HasForeignKey("LeafScan.Domain.Entities.CropRequirement", "CropId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
