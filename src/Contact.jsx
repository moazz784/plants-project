...
                className="w-full border-b outline-none py-2 resize-none"
              />
            </div>

            <div className="md:col-span-2 flex justify-end mt-6">
              <button className="bg-green-700 text-white px-8 py-3 rounded-lg shadow-md hover:bg-green-800 transition">
                Send Message
              </button>
            </div>
          </form>
