...
          
          <div className="max-w-xl flex flex-col ${isArabic ? 'items-start text-right' : 'items-start text-left'}`}">
            <h1 className="text-4xl md:text-5xl font-semibold text-green-700 mb-4">
             {t("categories_title")}
            </h1>
...
                className="relative w-[95%] md:w-[80%] lg:w-[70%] max-w-4xl aspect-video bg-black rounded-3xl overflow-hidden shadow-[0_35px_60px_-15px_rgba(0,0,0,0.6)] border-2 border-green-600/20 pointer-events-auto z-[110]"
              >
                
                <button 
                  onClick={() => setShowVideo(false)}
                  className="absolute top-4 right-4 z-[120] bg-white text-green-700 hover:bg-green-100 p-1.5 rounded-full shadow-md transition-all"
                >
                  <X size={20} />
                </button>
