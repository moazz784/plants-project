...
const resources = {
  en: {
    translation: {
      ...
      healthy_message: "Your plant appears to be in good health. No disease was detected. Continue your current care routine.",
      disease_message: "The AI model detected {{displayName}}. Review the cards below for symptoms, treatment, and care advice.",
      ...
      low: "Low",
      diagnosis: "Diagnosis",
      healthy_diagnosis: "No disease detected. The leaf appears healthy with normal coloration and structure.",
      disease_diagnosis: "Detected condition: {{displayName}}. The model classified this with {{confidence}}% confidence.",
      how_to_care: "How to care",
      healthy_care: "Maintain regular watering, adequate sunlight, and good air circulation. Monitor leaves weekly for any early signs of stress.",
      disease_care: "Isolate the affected plant immediately. Remove visibly infected leaves and dispose of them. Improve ventilation and reduce leaf wetness.",
      treatment: "Treatment",
      healthy_treatment: "No treatment needed at this time. Continue standard fertilization and pest monitoring.",
      disease_treatment: "Apply an appropriate fungicide or bactericide depending on the diagnosed condition. Consult a local agricultural extension officer for product recommendations specific to your region.",
      tips_and_tricks: "Tips & tricks",
      tips_content: "For best detection accuracy, photograph a single leaf against a plain background in natural daylight. Avoid shadows and keep the leaf flat and fully visible in the frame.",
      ...
      leafscan_dashboard: "LeafScan Dashboard",
      stats_empty_title: "Stats are empty",
      stats_empty_message: "Totals come from saved scans in the database. If users get results but this stays at zero, the API may not be persisting predictions (often missing seed migration on the server).",
      loading_server_diagnostics: "Loading server diagnostics…",
      total_images: "Total images",
      today: "Today",
      last_7_days: "last 7 days",
      disease_distribution: "Disease Distribution",
      non_healthy_diagnoses: "Non-healthy diagnoses",
      daily_image_analysis: "Daily Image Analysis",
      general_information: "General Information",
      live: "Live",
      healthy_vs_diseased: "Healthy vs Diseased",
      share_of_ai_diagnoses: "Share of AI diagnoses with a healthy class vs any other label.",
      total_diagnoses: "Total diagnoses",
      diagnoses_today: "Diagnoses today",
      healthy: "Healthy",
      diseased: "Diseased",
      most_common_diseases: "Most Common Diseases",
      no_diagnoses_yet: "No diagnoses yet.",
      no_diseased_scans: "No diseased scans yet — all diagnoses are healthy.",
      images: "images",
      stats_empty_sub: "Totals come from saved scans in the database. If users get results but this stays at zero, the API may not be persisting predictions (often missing seed migration on the server)."
    }
  },
  ...
  ar: {
    translation: {
      ...
      detection_result: "نتيجة التشخيص",
      healthy_message: "يبدو أن نباتك في حالة صحية جيدة. لم يتم اكتشاف أي مرض. يمكنك الاستمرار في روتين العناية الحالي.",
      disease_message: "نموذج الذكاء الاصطناعي اكتشف {{displayName}}. راجع البطاقات أدناه للحصول على معلومات حول الأعراض والعلاج ونصائح العناية.",
      detected_plant: "النبات المكتشف",
      confidence: "نسبة الثقة",
      high: "مرتفعة",
      medium: "متوسطة",
      low: "منخفضة",
      diagnosis: "التشخيص",
      healthy_diagnosis: "لم يتم اكتشاف أي مرض. الورقة تبدو صحية مع لون وهيكل طبيعيين.",
      disease_diagnosis: "الحالة المكتشفة: {{displayName}}. صنف النموذج هذا بنسبة ثقة {{confidence}}%.",
      how_to_care: "كيفية العناية",
      healthy_care: "حافظ على الري المنتظم، وأشعة الشمس الكافية، وتدوير الهواء الجيد. راقب الأوراق أسبوعياً لأي علامات مبكرة للإجهاد.",
      disease_care: "اعزل النبات المصاب فوراً. قم بإزالة الأوراق المصابة ظاهرياً وتخلص منها. حسّن التهوية وقلل من رطوبة الأوراق.",
      treatment: "العلاج",
      healthy_treatment: "لا حاجة للعلاج في هذا الوقت. استمر في التسميد المنتظم ومراقبة الآفات.",
      disease_treatment: "استخدم مبيداً فطرياً أو بكتيرياً مناسباً حسب الحالة التي تم تشخيصها. استشر مسؤول الإرشاد الزراعي المحلي للحصول على توصيات المنتجات المناسبة لمنطقتك.",
      tips_and_tricks: "نصائح وإرشادات",
      tips_content: "للحصول على أفضل دقة للكشف، قم بتصوير ورقة واحدة على خلفية عادية في ضوء النهار الطبيعي. تجنب الظلال وحافظ على الورقة مسطحة ومرئية بالكامل في الإطار.",
      prediction_confidence: "نسبة ثقة التوقع",
      top_predictions: "أفضل 3 توقعات",
      go_back: "العودة",

      // ===== Dashboard =====
      loading_dashboard: "جاري تحميل لوحة التحكم...",
      leafscan_dashboard: "لوحة تحكم LeafScan",
      stats_empty_title: "الإحصائيات فارغة",
      stats_empty_message: "الإجماليات تأتي من الفحوصات المحفوظة في قاعدة البيانات. إذا حصل المستخدمون على نتائج ولكن تبقى هذه القيم صفراً، فقد لا يتم حفظ التوقعات في قاعدة البيانات (غالباً بسبب عدم ترحيل البيانات الأولية على الخادم).",
      loading_server_diagnostics: "جاري تحميل تشخيصات الخادم...",
      total_images: "إجمالي الصور",
      today: "اليوم",
      last_7_days: "آخر 7 أيام",
      disease_distribution: "توزيع الأمراض",
      non_healthy_diagnoses: "تشخيصات غير صحية",
      daily_image_analysis: "تحليل الصور اليومي",
      general_information: "معلومات عامة",
      live: "مباشر",
      healthy_vs_diseased: "صحي مقابل مريض",
      share_of_ai_diagnoses: "نسبة تشخيصات الذكاء الاصطناعي للفئة الصحية مقابل أي فئة أخرى.",
      total_diagnoses: "إجمالي التشخيصات",
      diagnoses_today: "التشخيصات اليوم",
      healthy: "صحي",
      diseased: "مريض",
      most_common_diseases: "الأمراض الأكثر شيوعاً",
      no_diagnoses_yet: "لا توجد تشخيصات بعد.",
      no_diseased_scans: "لا توجد فحوصات مريضة حتى الآن - جميع التشخيصات سليمة.",
      images: "صورة",
      stats_empty_sub: "الإجماليات تأتي من الفحوصات المحفوظة في قاعدة البيانات. إذا حصل المستخدمون على نتائج ولكن تبقى هذه القيم صفراً، فقد لا يتم حفظ التوقعات في قاعدة البيانات (غالباً بسبب عدم ترحيل البيانات الأولية على الخادم)."
    }
  }
};
